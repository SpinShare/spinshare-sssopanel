  ...
  <div class="controlBrackets">
    ...
    <InputGroup title="Bracket Selection">
        <select v-model="bracketSel" @change="onChange($event)">
            <option value="1932027">QUALIFIERS │ POOL 1</option>
            <option value="1932028">QUALIFIERS │ POOL 2</option>
            <option value="1932029">QUALIFIERS │ POOL 3</option>
            <option value="1932030">QUALIFIERS │ POOL 4</option>
            <option value="1932031">QUALIFIERS │ POOL 5</option>
            <option value="1932032">QUALIFIERS │ POOL 6</option>
            <option value="1932033">QUALIFIERS │ POOL 7</option>
            <option value="1932034">QUALIFIERS │ POOL 8</option>
            <option value="1932036">CHALLENGER BRACKET</option>
            <option value="1932035">ELITE BRACKET</option>
            <option value="1761349">TEST │ QUALI</option>
            <option value="1761353">TEST │ KNOCKOUT</option>
        </select>
    </InputGroup>
