<template>
    <div class="screenCommentators4">
        <div class="obs-ninja">
            <webview :src="'https://obs.ninja/?scene&room=' + obsNinjaViewID + '&password=' + obsNinjaViewPassword + '&cleanoutput=true&transparent=true&hideheader=true&showlabels=skype&style=2'" ref="obsNinjaWebview4"></webview>
        </div>
