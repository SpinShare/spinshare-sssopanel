<template>
    <div class="screenBrackets">
		...
		<div class="blobs">
            ...
            <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                <path fill="#7c5ca4" d="M52.8,-18.5C60,5.2,51.8,32.6,34.6,44.3C17.4,56,-8.8,52,-24.2,39.4C-39.7,26.7,-44.5,5.3,-38.7,-16.4C-32.8,-38.1,-16.4,-60.2,3.2,-61.3C22.8,-62.3,45.5,-42.2,52.8,-18.5Z" transform="translate(100 100)" />
            </svg>
            <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                <path fill="#49dee3" d="M35.4,-7.2C42.9,11.7,44,36.9,29.7,49.3C15.4,61.7,-14.5,61.3,-30.1,48.3C-45.7,35.3,-47.2,9.8,-39.8,-8.9C-32.4,-27.5,-16.2,-39.1,-1.1,-38.8C13.9,-38.4,27.9,-26,35.4,-7.2Z" transform="translate(100 100)" />
            </svg>
            <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
		...
		<div class="commentators-box">
            <webview :class="isFullscreen ? 'isFullscreen' : ''" src="0"></webview>
        </div>
         <div class="music">
    ...
    .screenBrackets {
		...
		& .blobs {
            ...
            & svg {
                ...
                // Bottom Center
                &:nth-child(1) { top: 78vh; left: 58vw; animation-delay: -1s; }
                &:nth-child(2) { top: 78vh; left: 45vw; animation-delay: -2s; }
                &:nth-child(3) { top: 80vh; left: 50vw; animation-delay: -3s; }
                // Top Center
                &:nth-child(4) { top: 3vh; left: 37vw; animation-delay: -4s; }
                &:nth-child(5) { top: 14vh; left: 32vw; animation-delay: -5s; }
                &:nth-child(6) { top: 10vh; left: 45vw; animation-delay: -6s; }
                // Top Left
                &:nth-child(7) { top: 4vh; left: 3vw; animation-delay: -7s; }
                &:nth-child(8) { top: 13vh; left: 6vw; animation-delay: -8s; }
                // Top Right
                &:nth-child(9) { top: 4vh; left: 88vw; animation-delay: -9s; }
                &:nth-child(10) { top: 2vh; left: 85vw; animation-delay: -10s; }
				// Extras
                &:nth-child(11) { top: 70vh; left: 2vw; animation-delay: -11s; }
                &:nth-child(12) { top: 80vh; left: 85vw; animation-delay: -12s; }
                &:nth-child(13) { top: 75vh; left: 10vw; animation-delay: -13s; }
                &:nth-child(14) { top: 88vh; left: 4vw; animation-delay: -14s; }
            }
		}
