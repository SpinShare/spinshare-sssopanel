<template>
    <div class="screenCountdown">
        ...
        <div class="logo">
            ...
            <img src="../../assets/img/Logo_SSSO_Summer2023_OnDark.svg" alt="SSSO Logo" />
        </div>
...
<style scoped lang="less">
    ...
    & .timer {
        ...
        /*text-shadow: 1px 1px 0 #333, -1px -1px 0 #333, 1px -1px 0 #333, -1px 1px 0 #333, 15px 15px 6px rgba(0,0,0,0.65);*/
        font-weight: 900;
        & div{
